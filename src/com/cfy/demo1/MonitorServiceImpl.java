...
//		long usedMemory = (osmxb.getTotalPhysicalMemorySize() - osmxb.getFreePhysicalMemorySize()) / kb;
		...
		ObjectName objectName = osmxb.getObjectName();
		double systemLoadAverage = osmxb.getSystemLoadAverage();
		String version = osmxb.getVersion();
		System.out.println(String.format("arch : %s, availableProcessors : %s, name : %s, objectName : %s, systemLoadAverage : %s, version : %s, ", arch,availableProcessors,name,objectName,systemLoadAverage,version));
